...
Frontend and backend are now separated into sibling folders:
- `frontend/` (this folder)
- `backend/` (at project root)

Default Mongo connection values:
...
If needed, set `VITE_BACKEND_URL` in your frontend environment.

If you use a different Mongo instance, update `../backend/.env`.

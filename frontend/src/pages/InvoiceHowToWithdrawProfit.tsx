...
import { ArrowLeft, ArrowDownToLine, WalletCards } from 'lucide-react';
import { useAuthStore } from '@/store';
import { Button } from '@/components/ui/button';
import MobileBottomNav from '@/components/MobileBottomNav';
import type { MarketplaceInvoice } from '@/types';

export default function InvoiceHowToWithdrawProfit() {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-16 py-2 sm:py-0 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-semibold">How can I Withdraw my Profit?</p>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        >
          ...
          <div className="relative">
            <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-[28px] border border-cyan-400/20 bg-cyan-400/10 text-cyan-300 shadow-lg shadow-cyan-500/10">
              <ArrowDownToLine className="h-11 w-11" />
            </div>

            <div className="mt-6 text-center">
              <h1 className="text-3xl font-black tracking-tight text-white">It&apos;s pretty simple!</h1>
              <div className="mx-auto mt-4 max-w-2xl space-y-4 text-base leading-8 text-white/75 sm:text-lg">
                <p>
                  Once your invoice is approved, reward points are added to your account. After that, you can submit a redemption request in My Rewards, where your RP is converted at 1 RP = $0.01.
                </p>
                <p>
                  When your redemption is approved, the amount is credited to your Income Wallet. From there, you can withdraw it from the Withdraw section to your saved USDT (BEP-20) address.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 rounded-2xl border border-cyan-400/15 bg-cyan-500/10 p-5">
              <div className="flex items-start gap-3">
                <div className="mt-0.5 flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-400/15 text-cyan-300">
                  <WalletCards className="h-5 w-5" />
                </div>
                <div>
                  <p className="text-lg font-bold text-white">Important</p>
                  <p className="mt-1 text-sm leading-6 text-cyan-100/80">
                    Withdrawal is done from your Income Wallet after redemption approval, not directly from the pending invoice.
                  </p>
                </div>
              </div>
            </div>
